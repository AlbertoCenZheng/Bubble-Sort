...
public class BubbleSort {
	...
	public static void printArray(int[] myArray) {
		...
		for (int i = 0; i < myArray.length; i++) {
			...
			if (i < myArray.length - 1)// because of there is nothing more after
				System.out.print("->"); // the last item
	...
	public static void main(String[] args) {
		...
		int[] myArray = new int[10]; // create and initialize the size of the
										// array;
